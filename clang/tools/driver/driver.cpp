...
int clang_main(int Argc, char **Argv, const llvm::ToolContext &ToolContext) {
  ...
  Args.push_back("-fno-sanitize=alignment,bool,builtin,bounds,enum,float-cast-overflow,float-divide-by-zero,function,implicit-unsigned-integer-truncation,implicit-signed-integer-truncation");
